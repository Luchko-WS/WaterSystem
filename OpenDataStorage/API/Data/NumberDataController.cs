...
{
    public class NumberDataController: DataController<NumberCharacteristicValue>
    {
        private CharacteristicType _supportedCharacteristicType = CharacteristicType.Number;
